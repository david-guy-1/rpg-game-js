...
class D_Current_quests extends React.Component {
	props : {quests : quest[]}
	constructor(props : {quests : quest[]}){
		super(props);
...
//name,dungeons,shops,quest_takers
	...
	render(){
		...
		"width":c.quest_display_width, "height":c.quest_display_height,  "overflowY":"scroll", "overflowX":"hidden"
		}}>
		...
		"width":c.quest_display_completed_width, "height":c.quest_display_completed_height,  "overflowY":"scroll", "overflowX":"hidden"
		}}>
