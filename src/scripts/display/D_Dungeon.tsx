...
import * as D from "../canvasDrawing";
...
class D_Dungeon extends React.Component {
	...
	var skills_button_css = {"position":"absolute", "top":c.skills_button_top_left[1], "left":c.skills_button_top_left[0], "width":c.skills_button_width, "height":c.skills_button_height , "backgroundColor":"lightgreen"} as React.CSSProperties;
	var inv_button_css = {"position":"absolute", "top":c.inv_button_top_left[1], "left":c.inv_button_top_left[0],"width":c.inv_button_width, "height":c.inv_button_height , "backgroundColor":"lightblue"} as React.CSSProperties;
	//css for canvas
	var canvas_css = {"position":"absolute", "top":c.dungeon_top_left[1], "left":c.dungeon_top_left[0]} as React.CSSProperties;
	...
	<button style={skills_button_css} onClick={function() {view.go_to_skills();controller.rerender();}}> <h2 style={{"textAlign":"center"}}>Skills</h2> </button>
	<button style={inv_button_css} onClick={function(){view.go_to_inventory();controller.rerender();}}> <h2 style={{"textAlign":"center"}}>Inventory</h2></button></span>
	...
	//	console.log(py);
		...
		var canvas = this.refs.dungeon_canvas as any;
