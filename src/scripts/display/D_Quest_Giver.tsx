...
class D_Quest_Giver extends React.Component { 
	props : {"name":string, "quests":quest[]}
	constructor(props : {"name":string, "quests":quest[]}){
		super(props);
	...
	return <div>
		...
		<div id="instructions" style={{"position":"absolute", "top":10,"left":500} as React.CSSProperties} >{T.instructions_text["quest giver"]}</div>
					  
		<img src={require("../../images/" + T.quest_giver_data[name].image ) } 
		style={{"position":"absolute", "top":0,"left":0}as React.CSSProperties}/> 
		<div style={{"position":"absolute", "top":boxLocation[1],"left":boxLocation[0], "width":boxLocation[2] - boxLocation[0], "height":boxLocation[3] - boxLocation[1], "overflowY":"scroll", "overflowX":"hidden"}  as React.CSSProperties}> 
