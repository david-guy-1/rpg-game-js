...
//name,dungeons,shops,quest_takers
	...
	render(){
		...
		return (<div>
					  <div id="instructions" style={{"position":"absolute", "top":10,"left":500} as React.CSSProperties} >{T.instructions_text["town"]}</div>
					  
		<img src={require("../../images/" + T.town_data[town.name].image ) } 
		style={{"position":"absolute", "top":0,"left":0}}/>
		
		<canvas ref={this.canvasRef} style={{"position":"absolute", "top":0,"left":0} as React.CSSProperties} width={1600} height={720}/>
		</div>
	    );
	}
	componentDidMount(){
